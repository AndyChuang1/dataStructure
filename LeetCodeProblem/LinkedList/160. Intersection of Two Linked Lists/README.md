...
1. 使用 hashTable
2. 把 linked list A node 都加入 hashTable
3. 遍尋 linked list B , 如果 node 存在於 linked list A 的 hash table 就 return 該 node 找到交集
